import { User, Mail, School, MapPin, Shield, Edit3, LogOut, CreditCard, Sun, Moon } from 'lucide-react';
...
export default function StudentProfile({ onLogout, toggleTheme, isDarkMode }: StudentProfileProps) {
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      <section className="text-center">
        <div className="relative inline-block">
          <img src="https://picsum.photos/seed/harshith/200/200" alt="Harshith" className="w-32 h-32 rounded-3xl border-4 border-brand/20 object-cover shadow-2xl" referrerPolicy="no-referrer" />
        ...
        <h2 className="text-3xl font-black font-headline tracking-tighter mt-6 text-text-primary">Harshith Kudikala</h2>
        <p className="text-brand-accent font-bold uppercase tracking-widest text-xs mt-1">B.Tech • Mechanical Engineering</p>
      </section>
      ...
      <div className="flex justify-center gap-8 py-4 border-y border-border-subtle">
         <div className="text-center">
             <p className="text-2xl font-black font-headline text-text-primary">4th</p>
             <p className="text-[10px] text-text-secondary font-bold uppercase tracking-widest">Semester</p>
         </div>
         <div className="text-center">
             <p className="text-2xl font-black font-headline text-text-primary">7.69</p>
             <p className="text-[10px] text-text-secondary font-bold uppercase tracking-widest">CGPA</p>
         </div>
         <div className="text-center">
             <p className="text-2xl font-black font-headline text-text-primary">124</p>
             <p className="text-[10px] text-text-secondary font-bold uppercase tracking-widest">Credits</p>
         </div>
      </div>

      <div className="space-y-4">
         {[
           { icon: <Mail size={18} />, label: 'Email', value: 'harshith@institute.edu' },
           { icon: <CreditCard size={18} />, label: 'Student ID', value: 'BT-2022-012' },
           { icon: <School size={18} />, label: 'Campus', value: 'Main Block, Wing A' },
           { icon: <Shield size={18} />, label: 'Account Type', value: 'Premium Student' },
         ].map((item, i) => (
